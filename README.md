...
- Автономное Android-приложение со всем основным функционалом сайта.
- Серверные организации, участники и защищённая синхронизация устройств.
- Экспорт мобильных отчётов в CSV, XLSX и PDF.
